export const mockData = [
  ...
  },
  {
    ...
    employee: "Maria Santos",
    department: "Human Resources",
    dateOfLiquidation: "2025-06-15",
    status: "Pending",
    amountObtained: 7500,
    amountExpended: 7300,
    reimburseOrReturn: 200,
    transactions: [
      {
        date: "2025-06-12",
        rtNumber: "RT011",
        storeName: "Jollibee",
        particulars: "Team lunch",
        from: "Office",
        to: "Alabang",
  ...
  },
  {
    id: "liq-7",
    formType: "Liquidation",
    description: "Client meeting logistics",
    employee: "John Dela Cruz",
    department: "Sales",
    dateOfLiquidation: "2025-06-18",
    status: "Pending",
    amountObtained: 5000,
    amountExpended: 5200,
    reimburseOrReturn: -200,
    transactions: [
      ...
      },
      {
        ...
        rtNumber: "RT014",
        storeName: "Starbucks",
        particulars: "Client refreshments",
        from: "Tagaytay",
        to: "Manila",
        transportation: "Grab",
        amount: 3200,
